 ...
 * @author quenq
 */
public class Ajoutprofessur extends javax.swing.JDialog  {

    /**
     * Creates new form Ajoutélève
     */

    public Ajoutprofessur(java.awt.Frame jFrame, boolean b) {
        super(jFrame,b);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ajout professeur");
    ...
    private void insertionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertionActionPerformed
        ...
        try {
            isr.Insertion("INSERT INTO personne (id,nom, prénom, type) VALUES (NULL ,"+"'"+name+"'"+", "+"'"+surname+"'"+", '1')");
        } catch (SQLException e) {
            Logger.getLogger(Ajoutprofessur.class.getName()).log(Level.SEVERE, null, e);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ajoutprofessur.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable(){ 
            public void run() {
                Ajoutprofessur wdw = new Ajoutprofessur (new javax.swing.JFrame(), true);
